...
//       {/* Add Modal */}
//       <ModalPopup title="Blacklist Package" sideImg={sideImg} modalName="addProduct">
//         <div className="grid w-full grid-cols-2 gap-5 px-10 ml-5">
//           <Input name="Tariff ID" type="text" value={payload.TARIFF_ID} onChange={(e) => setPayload({ ...payload, TARIFF_ID: e.target.value })} />
//           <Input name="Package Name" type="text" value={payload.PACKAGE_NAME} onChange={(e) => setPayload({ ...payload, PACKAGE_NAME: e.target.value })} />
//            <Input name="Created user" type="text" value={payload.CREATED_USER} onChange={(e) => setPayload({ ...payload, CREATED_USER: e.target.value })} />
...
//       {/* Update Modal */}
//       <ModalPopup title="Update Blacklist Package" sideImg={sideImg} modalName="updateProduct">
//         <div className="grid w-full grid-cols-2 gap-5 px-10 ml-5">
//           <Input name="Tariff ID" type="text" value={payload.TARIFF_ID} onChange={(e) => setPayload({ ...payload, TARIFF_ID: e.target.value })} />
//           <Input name="Package Name" type="text" value={payload.PACKAGE_NAME} onChange={(e) => setPayload({ ...payload, PACKAGE_NAME: e.target.value })} />
//           <Dropdown name="Status" value={payload.STATUS} status={["Active", "Inactive"]} onChange={(e) => setPayload({ ...payload, STATUS: e.target.value })} />
//           <Input name="Updated user" type="text" value={payload.UPDATED_USER} onChange={(e) => setPayload({ ...payload, UPDATED_USER: e.target.value })} />
