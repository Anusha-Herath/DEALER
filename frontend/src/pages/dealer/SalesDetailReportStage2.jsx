...
function SalesDetailReportStage2() {
  ...
  const data = Array.isArray(response)
    ? response
        ...
        .map((item) => ({
          ...
          "Commision Stage 2": item.commision_stage_2 || "",
        }))
    : [];
  ...
  return (
    <div className="block">
      ...
      <PageHeader title="Sales Detail Report Stage 2" />
...
export default SalesDetailReportStage2;
